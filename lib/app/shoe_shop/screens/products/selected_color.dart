...
class SelectedColor extends StatefulWidget {
  ...
  const SelectedColor({Key? key, this.othersImage, this.callBackColor})
      : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        ...List.generate(
            widget.othersImage!.length, (index) => _itemColor(context, index))
      ],
    );
  }
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                ...
                image: CachedNetworkImageProvider(
                    widget.othersImage![index].urlPhoto![4])),
            border: iChoice[index]
                ? Border.all(width: 1, color: Colors.black)
                : Border.all(width: 0.5, color: Colors.black.withOpacity(0.5))),
      ),
    );
  }
}
