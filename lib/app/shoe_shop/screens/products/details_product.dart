...
class DetailsShoe extends StatefulWidget {
  ...
  String? tag;
  DetailsShoe({Key? key, this.product, this.listKey, this.listCart, this.tag})
      : super(key: key);
  @override
...
class _DetailsShoeState extends State<DetailsShoe> {
  ...
  _mainBody(BuildContext context) {
    return Stack(
      children: [
        CustomScrollView(
          slivers: [_sliverAppbar(context), _sliverBody(context)],
        ),
        Positioned(
            bottom: 0,
            child: Container(
                      ...
                      onAddToCart: () {
                        _onAddToCart(
                            ...
                            Cart(
                              ...
                              idCategoryProduct:
                                  widget.product!.idCategoryProduct,
                              name: widget.product!.name,
                              urlPhoto: widget.product!.othersImage![colorIndex]
                                  .urlPhoto![0],
                              color: widget
                                  .product!.othersImage![colorIndex].color,
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: Hero(
            ...
            child: CachedNetworkImage(
              imageUrl: widget.product!.othersImage![colorIndex].urlPhoto![0],
              fit: BoxFit.cover,
            )),
      ),
      actions: [
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                SelectedColor(
                  othersImage: widget.product!.othersImage!,
                  callBackColor: (val) {
                    setState(() {
                      colorIndex = val;
                    });
          ...
          Container(
            ...
            child: ListView.builder(
                itemCount:
                    widget.product!.othersImage![colorIndex].urlPhoto!.length,
      ...
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
              ...
              image: CachedNetworkImageProvider(
                  widget.product!.othersImage![colorIndex].urlPhoto![index])),
          boxShadow: [
            BoxShadow(
