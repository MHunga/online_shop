...
class AddToCartButton extends StatefulWidget {
  ...
  const AddToCartButton({Key? key, this.cartKey, this.onAddToCart})
      : super(key: key);
  @override
...
class _AddToCartButtonState extends State<AddToCartButton>
  ...
  _onAnimate() {
    ...
    _animation2 = MaterialPointArcTween(
            begin: Offset.zero,
            end: Offset(
                (positionCart.dx - MediaQuery.of(context).size.width / 2 + 12) *
                    5.0,
                -(positionButton.dy - positionCart.dy) * 5.0))
        .animate(_animationController2!);
