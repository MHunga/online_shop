  ...
  _paymentMethod(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            S.current.payment_methods,
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
          ),
          _itemRowMethod(
              iconLink: IconsLinks().credit, title: "Credit Card", index: 0),
          _itemRowMethod(
              iconLink: IconsLinks().payPal, title: "PayPal", index: 1),
          _itemRowMethod(
              iconLink: IconsLinks().google, title: "Google Play", index: 2),
          _itemRowMethod(
              iconLink: IconsLinks().stripe, title: "Stripe", index: 3),
          SizedBox(
            height: 200,
          )
        ],
