...
class _SelectedLocationScreenState extends State<SelectedLocationScreen> {
          ...
          FlatButton(
              ...
              onPressed: () {
                pushNewScreen(context,
                    screen: PaymentScreen(), withNavBar: false);
              },
  ...
  _locationItem(
      {BuildContext? context, int? index, String? title, String? sub}) {
    return Container(
      width: MediaQuery.of(context!).size.width,
